# sap-hana-for-geoevent

ArcGIS 10.7+ GeoEvent Extension for Server sample SAP Hana Ouptut Connector for sending GeoEvents to SAP Hana.

![App](hana-for-geoevent.png?raw=true)

## Features
* SAP Hana Outbound Transport
